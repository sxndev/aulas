// Uma higher order function é uma função que recebe uma outra como parâmetro, ou uma função que retorna outra função.

// FUNÇÃO COMO PARÂMETRO DE OUTRA FUNÇÃO

const calcularAnoDeNascimento = function ( idade, mesDeNascimento, imprimirAnoDeNascimento) {
  const mesAtual = 10;
