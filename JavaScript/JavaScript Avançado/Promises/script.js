...
/*
  promises servem para indicar se  houve sucesso (resolve) na execução de um código ou falha (reject), diminuindo o uso de callbacks e evitando o callback hell
*/